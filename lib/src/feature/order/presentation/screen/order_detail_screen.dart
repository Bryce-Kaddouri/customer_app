                              ...
                              Container(
                                ...
                                child: Row(
                                  children: [
                                    Container(
                                      ...
                                      child: Column(
                                        children: List.generate(
                                          ...
                                          (index) => Container(
                                            alignment: Alignment.centerLeft,
                                            height: orderModel.status.step > 1
                                                ? 44
                                                : 4,
                                            width: 2,
                                            child: Container(
                                              decoration: BoxDecoration(
                                                color: orderModel.status.step >
                                                        1
                                    ...
                                    Text(
                                        '${DateHelper.getFormattedDate(orderModel.createdAt)} at ${DateHelper.get24HourTime(material.TimeOfDay(hour: orderModel.createdAt.hour, minute: orderModel.createdAt.minute))}'),
                                  ],
                                ),
                              ),
                                      ...
                                      Container(
                                        ...
                                        child: Column(
                                          children: List.generate(
                                            ...
                                            (index) => Container(
                                              alignment: Alignment.centerLeft,
                                              height: orderModel.status.step > 2
                                                  ? 44
                                                  : 4,
                                              width: 2,
                                              child: Container(
                                      ...
                                      Container(
                                        ...
                                        child: Column(
                                          children: List.generate(
                                            ...
                                            (index) => Container(
                                              alignment: Alignment.centerLeft,
                                              height: orderModel.status.step > 3
                                                  ? 44
                                                  : 4,
                                              width: 2,
                                              child: Container(
                                ...
                                Container(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Text(
                                          '${DateHelper.getFormattedDate(orderModel.collectedAt!)} at ${DateHelper.get24HourTime(material.TimeOfDay(hour: orderModel.collectedAt!.hour, minute: orderModel.collectedAt!.minute))}'),
                                    ],
                                  ),
                                ),
                            ],
                          ...
                          onPressed: () async {
                            context.push(
                              ...
                              extra: {
                                ...
                                'order_time':
                                    '${orderModel.time.hour}:${orderModel.time.minute}',
                              },
                            );
                          },
                        ),
